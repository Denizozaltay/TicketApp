    ...
    <div className="header-column flex flex-col flex-[0_0_20%] bg-[#FDFDFD] shadow-lg  text-white gap-4 p-4 box-border h-full overflow-hidden">
      ...
      <div className="contentsAll m-0">
        ...
        <div
          ...
          [&>div]:flex [&>div]:flex-1 [&>div]:no-underline [&>div]:py-5 [&>div]:px-0 [&>div]:box-content [&>div]:text-[1rem] [&>div]:gap-[0.5rem] [&>div]:transition-all [&>div]:duration-300 [&>div]:ease-in-out [&>div]:cursor-default
          [&>div>a]:no-underline [&>div>a]:text-[1rem] [&>div>a:hover]:text-[rgba(0,111,255,1)] [&>div>a]:transition-all [&>div>a]:duration-300 [&>div>a]:ease-in-out
